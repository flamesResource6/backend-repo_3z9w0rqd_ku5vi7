...
@app.post("/api/askAgent", response_model=AskResponse)
async def ask_agent(payload: AskRequest):
    ...
    try:
        ...
        system_text = payload.systemInstruction or "You are an assistant."
        final_prompt = f"""
System Instruction:\n{system_text}\n\nUser Message:\n{payload.message}
"""
        ...
        raise HTTPException(status_code=500, detail=f"Gemini API error: {str(e)[:500]}")
